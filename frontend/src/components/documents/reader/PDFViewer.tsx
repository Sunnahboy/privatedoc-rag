...
const VIEWPORT_BACKGROUND = "bg-background";
  ...
  return (
    <section className={`pdf-viewer-shell relative flex h-full min-h-0 flex-col ${VIEWPORT_BACKGROUND} text-on-surface`} aria-label="Document reader">
      ...
      {readingMode === "focus" && (
        ...
        >
          <div className="mx-3 mt-3 flex items-center justify-between gap-2 rounded-md border border-outline-variant/30 bg-surface/95 px-3 py-2 backdrop-blur-[1px] md:mx-6">
            <button
              type="button"
              onClick={() => onReadingModeChange?.("normal")}
              className="pointer-events-auto inline-flex h-8 items-center gap-1 rounded-md border border-outline-variant/30 bg-surface-elevated px-2.5 text-xs font-medium text-on-surface transition-colors hover:bg-surface focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
            >
              <span className="material-symbols-outlined text-[16px]">arrow_back</span>
              Exit focus
            </button>

            <div className="pointer-events-auto flex items-center gap-1 rounded-md border border-outline-variant/30 bg-surface-elevated p-1">
              <button
                type="button"
                aria-label="Previous page"
                onClick={goToPrevious}
                disabled={isAtFirstPosition || navigationLocked}
                className="inline-flex h-9 items-center justify-center rounded-md border border-outline-variant/30 bg-surface-elevated px-3 text-sm text-on-surface transition-colors hover:bg-surface focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 disabled:cursor-not-allowed disabled:opacity-50"
              >
      ...
      <div ref={shellRef} className="min-h-0 flex-1">
        ...
        >
          ...
          <Document
            ...
            error={
              <div className="flex min-h-[60vh] items-center justify-center">
                <div className="max-w-md rounded-xl border border-outline-variant/30 bg-surface-elevated px-6 py-5 text-center shadow-sm">
          ...
          {sequentialTurningEnabled && loadState !== "error" && (
            <>
              <button
                ...
                disabled={isAtFirstPosition || navigationLocked}
                className={`pointer-events-auto absolute bottom-6 left-0 top-6 z-5 hidden w-12 items-center justify-center rounded-r-md text-on-surface-variant transition-all duration-200 hover:bg-surface-container focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 disabled:opacity-30 md:flex md:w-16 ${
              ...
              <button
                ...
                onPointerCancel={onEdgePointerCancel}
                disabled={isAtLastPosition || navigationLocked}
                className={`pointer-events-auto absolute bottom-6 right-0 top-6 z-5 hidden w-12 items-center justify-center rounded-l-md text-on-surface-variant transition-all duration-200 hover:bg-surface-container focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 disabled:opacity-30 md:flex md:w-16 ${
                  readingMode === "focus" && !showFocusHud ? "opacity-0" : "opacity-100"
                }`}
              >
                <span className="material-symbols-outlined text-[18px]">chevron_right</span>
