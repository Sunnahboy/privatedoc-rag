...
from .messages import ChatGenerationMessage, DocumentIngestMessage
...
async def publish_chat_job(
    ...
    async with pool.acquire() as channel:
        ...
        logger.warning(
            f"!!! PUBLISHING TO EXCHANGE: '{settings.CHAT_EXCHANGE_NAME}' WITH KEY: '{settings.CHAT_ROUTING_KEY}' !!!"
        )
